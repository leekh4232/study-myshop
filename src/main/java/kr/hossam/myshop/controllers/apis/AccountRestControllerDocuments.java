...
public class AccountRestControllerDocuments {
     ...
     */
    @GetMapping("/api/docs/account/id_unique_check")
     ...
     * @return 중복 여부 결과에 대한 JSON 응답
     */
    @GetMapping("/api/docs/account/email_unique_check")
     ...
     */
    @PostMapping("/api/docs/account/join")
     ...
     */
    @PostMapping("/api/docs/account/login")
     ...
     */
    @GetMapping("/api/docs/account/logout")
     ...
     */
    @PostMapping("/api/docs/account/find_id")
     ...
     */
    @PutMapping("/api/docs/account/reset_pw")
     ...
     */
    @DeleteMapping("/api/docs/account/out")
    ...
    @PutMapping("/api/docs/account/edit")
