...
public class AccountRestController {
     ...
     * @param userPw                // 현재 비밀번호 (정보 확인용)
     * @param newUserPw             // 신규 비밀번호 (정보 변경용)
     * @param newUserPwConfirm      // 신규 비밀번호 확인값
     * @param userName              // 이름
     * @param email                 // 이메일
     * @param phone                 // 전화번호
     * @param birthday              // 생년월일
     ...
     * @param photo                 // 프로필 사진 (선택 사항)
     * @return                      // 회원 정보 수정 결과에 대한 JSON 응답
    ...
    public Map<String, Object> edit(
            ...
            @RequestParam("addr1") String addr1,
            @RequestParam("addr2") String addr2,
            @RequestParam(value="delete_photo", defaultValue="N") String deletePhoto,   // [신규] 프로필 사진 삭제 여부(Y/N)
